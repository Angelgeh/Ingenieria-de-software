...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST['buscar'])) {
        ...
        try {
            ...
            $stmt = $conn->prepare("SELECT * FROM proveedor WHERE nom_prov LIKE :busqueda");
            $busqueda = "%$busqueda%";
            ...
            if ($stmt->rowCount() > 0) {
                ...
                echo "<table border='1'>";
                echo "<tr><th>ID Proveedor</th><th>Nombre Proveedor</th><th>Contacto</th></tr>";
...
<body>
    ...
    <form method="post">
        <label for="buscar">Buscar proveedor por nombre:</label>
